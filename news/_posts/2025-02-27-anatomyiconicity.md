...
This was part of a really wonderful BA project by Stella Punselie, supervised by Mark Dingemanse, which I was lucky to be invited to collaborate on just for the final bits. The figure below (Figure 2 from the paper) shows the general idea. We combine three different measures of iconicity: two behavioural (iconicity ratings and guessing accuracies, panels B and C) and one analytical (Stella and Mark's analyses of structured iconic mappings in the stimuli, panel A). The stimuli in question for this study were ideophones from five languages representing four language families: Japanese (Japonic), Ewe (Kwa, Niger-Congo), Korean (Koreanic), Semai (Aslian, Austroasiatic) and Siwu (Na-Togo, Niger-Congo). 
