...
There are 9 form features, which map to 7 semantic features (3 of the formal features relating to consonant, vowel, and tone weighting map to a single semantic feature for magnitude). Ideophones are coded first for their formal features, and then separately for their semantic features. 